...
describe('Theme', () => {
  ...
  it('is cloneable', () => {
    ...
    assert.deepEqual(theme.get('a'), themeClone.get('a'))
  })
  ...
  it('can teme.get() in source function', () => {
    var theme = new Theme()
  ...
  it('merges with additinal styles', () => {
    ...
    var style = theme.get('a', null, {foo: 2, baz: 0})
...
describe('resolve modifiers', () => {
  it('resolves booleans', () => {
    ...
    var style = theme.get('a', {foo: true, bar: false})
  ...
  it('resolves nesteds', () => {
    ...
    var style = theme.get('a', {taz: 'foo', bar: true})
